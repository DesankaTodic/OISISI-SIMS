...
public class WorkspaceTreeController implements TreeSelectionListener{
	...
	public void valueChanged(TreeSelectionEvent e) {
		...
		if(object instanceof Workspace){
			...
			menu = new MyPopupMenu(p);
			
		}else if(object instanceof Document){
			
			Document d = (Document)object;
			menu = new MyPopupMenu(d);
		...
		}else if(object instanceof GraphicSlot){
			
			GraphicSlot gs = (GraphicSlot)object;
			menu = new MyPopupMenu(gs);
			
		}else if(object instanceof TextSlot){
			
			TextSlot gs = (TextSlot)object;
			menu = new MyPopupMenu(gs);
			
		}else if(object instanceof SlotElement){
			
			SlotElement se = (SlotElement)object;
			menu = new MyPopupMenu(se);
		}

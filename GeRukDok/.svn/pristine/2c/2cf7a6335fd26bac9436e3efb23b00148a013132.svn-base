...
public class NewGraphicSlotAction extends AbstractAction {
	...
	public void changeName(){
		putValue(NAME, MyFrame.getInstance().getResourceBundle().getString("mnuNoviGrafickiSlot"));
		putValue(SHORT_DESCRIPTION, MyFrame.getInstance().getResourceBundle().getString("mnuNoviGrafickiSlot"));
	}
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (p instanceof Page) {
			GraphicSlot s = new GraphicSlot("", (Page) p);
			((Page) p).addSlot(s);
